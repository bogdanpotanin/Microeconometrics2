...
#---------------------------------------------------
# Часть 2. Логистическая регрессия и 
#          отношение шансов
#---------------------------------------------------
...
# ЗАДАНИЯ (* - средне, ** - сложно, *** - очень сложно)
# 2.1.    Добавьте в модель квадратный корень из объема
#         кредита и оцените:
...
# 2.2.    Используя встроенные данные Mroz87 из библиотеки sampleSelection 
...
# 2.3.    Используя встроенные данные wage1 из библиотеки np оцените, как
...
#---------------------------------------------------
# Часть 3. Оценивание вероятностей
#---------------------------------------------------
...
# 3.2.    Рассчитайте вероятность дефолта для индивида
...
# 3.3.    Не используя функцию predict() оцените для Бориса:
...
# 3.4. Используя встроенные данные Mroz87 из библиотеки
...
# 3.5. Используя встроенные данные wage1 из библиотеки np оцените
...
# 3.6. Рассчитайте долю индивидов в выборке, для которых
...
#---------------------------------------------------
# Часть 4. Оценивание предельных эффектов
#---------------------------------------------------
...
# ЗАДАНИЯ (* - средне, ** - сложно, *** - очень сложно)
# 4.1.    Для 28-летнего индивида без высшего образования
#         и с доходом 20000:
...
# 4.2. Используя встроенные данные Mroz87 из библиотеки
...
# 4.3.    Используя встроенные данные wage1 из библиотеки np 
