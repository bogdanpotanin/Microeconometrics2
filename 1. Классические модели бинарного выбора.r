...
# -----
# Учимся:
# 1. Тестировать гипотезы о вероятность и
#    предельных эффектах
# 2. Считать градиент вероятностей по параметрам
# -----
...
# 2. Реализовывать LM тест о корректности
#    спецификации зависимости индекса
#    от регрессоров
# -----
